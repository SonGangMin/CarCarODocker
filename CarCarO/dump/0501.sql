...
--
-- Table structure for table `carsHashtag`
--

DROP TABLE IF EXISTS `carsHashtag`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `carsHashtag` (
  `carsId` bigint NOT NULL,
  `hashtagsId` bigint NOT NULL,
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  PRIMARY KEY (`carsId`,`hashtagsId`),
  KEY `carsHashtag_FK_1` (`hashtagsId`),
  CONSTRAINT `carsHashtag_FK` FOREIGN KEY (`carsId`) REFERENCES `cars` (`num`),
  CONSTRAINT `carsHashtag_FK_1` FOREIGN KEY (`hashtagsId`) REFERENCES `hashtags` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `carsHashtag`
--

LOCK TABLES `carsHashtag` WRITE;
/*!40000 ALTER TABLE `carsHashtag` DISABLE KEYS */;
/*!40000 ALTER TABLE `carsHashtag` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users` (
  ...
  `birth` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `grade` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `users_UN` (`no`),
  UNIQUE KEY `users2_UN` (`email`,`tel`)
...
INSERT INTO `users` VALUES (1,'admin','관리자','$2b$12$axVl/qpDI46EsU1oDepL1.l0BH/Bwfmp55rSycQf21CBMzV5RUBRS','admin@admin.com','01012345678','99',3),(2,'kbj001211','김병제','$2b$12$nf24.NvqhxZ6xvbcyF/7yu/Hkj.4x1HIqRSHGXEBk7fSGwx9FaBw2','kbj@kbj','01010101010','24',2),(8,'rlaekgns1','김다훈','$2b$12$zmllBkWdo8SXfa3JIrCZgulhSzVplRui.y8uJJIcy.dXXtSc5E9We','01010101','101010101','010101',2),(4,'skm0628','손강민','$2b$12$MX3gNEjrvIjIIUUDRXgF3O.4sRXSWiJoduEo2EVQ5neVtqnPiopLa','skm0628@naver.com','01049775695','31',2),(5,'skmin0628','손강민','$2b$12$Dg91tjy9JeO2DVnMwjQzfullOQU9oeH9iL.BlQG4xrq6Mwis9YbSe','s@s.com','01049775695','13',1),(6,'user','일반유저','$2b$12$J4WpzT4lxse1QG4DPRFsReNfWqssbd19YOnTk58LgunwaWDUD6Y92','user@user.com','01011111111','1',1),(7,'weise','LSH','$2b$12$Xy0cQJP9A6O2stOhdi99suM0QoLnmTQ95/jfVgUaxvrVbYTom7252','a','123123','3',2);
...
-- Dump completed on 2023-05-01 17:13:57
